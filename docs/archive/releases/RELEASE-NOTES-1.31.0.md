# Pool Shed v1.31.0 - Quotes First + Simplified Project Purchasing
...
v1.31.0 was built on the v1.28.0 responsive/Azzy baseline and the v1.29 Quote Studio integration. It does not replace the existing Product Hub, Inventory, Warehouse, Sales Order, Purchasing, Project, Finance, Azzy, permissions or notification engines.
...
- v1.31 native Quote Studio wiring
...
- v1.27.3 Azzy panel/cache authority on v1.31.0
...
The v1.28.0 responsive/Azzy baseline and v1.29.0 Quote Studio release were not overwritten during this work. Keep the previous deployment available until v1.31.0 has completed production smoke testing.


## v1.31.0 simplification
- Removed the retired request workflow from navigation, data authority, projects, purchasing, analytics, assistant search, permissions and action adapters.
- Project materials are now driven directly by linked Sales Orders, Purchase Orders, allocations, Job Bin stock and receipts.
- Quotes is a primary left-navigation item directly after Sales Orders.
- CRM customer profiles now include a New quote action that opens Quote Studio with the customer preselected.
