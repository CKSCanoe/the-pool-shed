...
ROOT=Path(__file__).resolve().parents[1]; PUBLIC=ROOT/'public'; ART=ROOT/'qa-v135'; ART.mkdir(exist_ok=True)
...
proposal={
 ...
 'investment':{'gross':0,'paymentMilestones':[{'label':'Secure project','percent':50,'amount':11250},{'label':'Installation stage','percent':40,'amount':9000},{'label':'Completion','percent':10,'amount':2250}]},
...
print(json.dumps({'V9_2_Portal':'PASS','Desktop':'PASS','Mobile':'PASS','RuntimeErrors':0,'screenshots':str(ART)},indent=2))
