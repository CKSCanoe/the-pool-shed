...
assert.match(html,/quote-customer-portal\.js\?v=1\.34\.0/);
...
console.log('PASS v1.34.0 customer portal isolation, service-role quote tables, immutable acceptance and non-duplicated engagement events');
