...
assert.match(html,/quote-customer-portal\.js\?v=1\.32\.1/);
...
console.log('PASS v1.32.1 customer portal isolation, service-role quote tables, immutable acceptance and non-duplicated engagement events');
