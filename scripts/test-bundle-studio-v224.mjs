...
const js=fs.readFileSync(new URL('../public/bundle-studio-v229.js',import.meta.url),'utf8');
const css=fs.readFileSync(new URL('../public/bundle-studio-v229.css',import.meta.url),'utf8');
...
const checks=[
  ...
  ['assets included',html.includes('bundle-studio-v229.css')&&html.includes('bundle-studio-v229.js')]
];
