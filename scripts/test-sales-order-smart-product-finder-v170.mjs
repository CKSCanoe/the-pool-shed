...
expect(index.includes("app.css?v=1.7.3"),"versioned CSS asset missing");
expect(index.includes("sales-workspace.js?v=1.7.3"),"versioned Sales workspace asset missing");
expect(sw.includes("pool-shed-v1.7.3-sales-order-finder-polish"),"service worker cache not advanced");
