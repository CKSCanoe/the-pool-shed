...
if (pkg.version !== '1.0.6') failures.push('package.json is not Version 1.0.6.');
if (vercel.outputDirectory !== 'dist') failures.push('Vercel outputDirectory must be dist.');
for (const file of ['bundle-system.js','bundle-studio.js','assets/css/system/20-features.css','assets/css/system/40-design-system.css']) {
