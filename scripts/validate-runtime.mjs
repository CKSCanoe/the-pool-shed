...
for (const file of [htmlPath, swPath, configPath, salesSearchPath, salesSearchCssPath, partialFulfilmentPath, partialFulfilmentCssPath, catalogueIntelligencePath, catalogueIntelligenceCssPath, productImagesPath, productImagesCssPath]) {
...
if (!swSource.includes('pool-shed-v1.11.4-product-images')) {
  throw new Error('Service worker cache version was not advanced to v1.11.4');
}
