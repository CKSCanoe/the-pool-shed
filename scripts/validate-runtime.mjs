...
if (!swSource.includes('pool-shed-v2.2.9-functional-bundle-actions')) {
  throw new Error('Service worker cache version was not advanced to v2.2.9 Functional Bundle Actions');
}
for (const asset of ['bundle-studio-v229.css', 'bundle-studio-v229.js']) {
  if (!swSource.includes(asset)) throw new Error(`Offline cache is missing ${asset}`);
}
