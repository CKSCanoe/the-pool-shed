...
if (!swSource.includes('pool-shed-v2.2.2-catalogue-search-fix')) {
  throw new Error('Service worker cache version was not advanced to v2.2.2 Catalogue Search Fix');
}
for (const asset of ['bundle-studio-v222.css', 'bundle-studio-v222.js']) {
  if (!swSource.includes(asset)) throw new Error(`Offline cache is missing ${asset}`);
}
