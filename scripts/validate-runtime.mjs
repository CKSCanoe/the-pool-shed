...
if (!swSource.includes('pool-shed-v1.10.5-sales-order-search')) {
  throw new Error('Service worker cache version was not advanced to v1.10.5');
}
...
for (const requiredFix of ['stockRowsForLocationScope', 'dashboardHealthSummary', 'seed.statuses.forEach', 'L-WH-A1', 'orderedDashboardStatuses']) {
