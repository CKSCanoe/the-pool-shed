...
if (!html.includes('./catalogue-intelligence.css') || !html.includes('./catalogue-intelligence.js')) {
  throw new Error('The v1.11.1 catalogue intelligence assets are not connected to index.html');
}
...
if (!swSource.includes('pool-shed-v1.11.1-premium-product-hub')) {
  throw new Error('Service worker cache version was not advanced to v1.11.1');
}
...
for (const requiredStyle of [
  ...
  'premium Product Hub refinements'
]) {
...
if (!catalogueDiagnostics || catalogueDiagnostics.version !== '1.11.1') {
...
console.log(`Runtime validation passed: ${count} inline scripts, service worker, offline sales search, catalogue intelligence, PO supplier-offer search, partial shipment balance test, premium UI and required app functions.`);
