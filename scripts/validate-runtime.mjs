...
if (!swSource.includes('pool-shed-v2.2.7-bulk-catalogue-picker')) {
  throw new Error('Service worker cache version was not advanced to v2.2.7 Bulk Catalogue Picker');
}
for (const asset of ['bundle-studio-v224.css', 'bundle-studio-v224.js']) {
  if (!swSource.includes(asset)) throw new Error(`Offline cache is missing ${asset}`);
}
