...
if (!html.includes('./catalogue-intelligence.css') || !html.includes('./catalogue-intelligence.js')) {
  throw new Error('The v1.11.0 catalogue intelligence assets are not connected to index.html');
}
...
if (!swSource.includes('pool-shed-v1.11.0-catalogue-intelligence')) {
  throw new Error('Service worker cache version was not advanced to v1.11.0');
}
...
if (!catalogueDiagnostics || catalogueDiagnostics.version !== '1.11.0') {
