...
if (!swSource.includes('pool-shed-v2.2.1-smart-bundle-studio')) {
  throw new Error('Service worker cache version was not advanced to v2.2.1 Smart Bundle Studio');
}
for (const asset of ['bundle-studio-v221.css', 'bundle-studio-v221.js']) {
  if (!swSource.includes(asset)) throw new Error(`Offline cache is missing ${asset}`);
}
