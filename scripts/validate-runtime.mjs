...
if (!swSource.includes('pool-shed-v1.11.7-catalogue-health-actions')) {
  throw new Error('Service worker cache version was not advanced to v1.11.7');
}
...
if (!catalogueDiagnostics || catalogueDiagnostics.version !== '1.11.4') {
