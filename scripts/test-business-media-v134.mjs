...
assert(index.includes('business-media.js?v=1.35.0'),'Product/CRM secure media client must load before product media rendering');
...
console.log('PASS v1.35.0 private Product Hub + CRM media, reusable quote assets and service-role-only storage');
