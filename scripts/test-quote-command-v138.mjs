...
assert.match(eng,/const VERSION='1\.44\.0'/);
...
assert(index.includes('app.css?v=1.44.0'));
assert(proposal.includes('quote-customer-portal.css?v=1.44.0'));
assert(proposal.includes('quote-customer-portal.js?v=1.44.0'));
