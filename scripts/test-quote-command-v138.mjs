...
assert.match(eng,/const VERSION='1\.41\.1'/);
...
assert(index.includes('app.css?v=1.41.1'));
assert(proposal.includes('quote-customer-portal.css?v=1.41.1'));
assert(proposal.includes('quote-customer-portal.js?v=1.41.1'));
