...
if(!html.includes('bundle-sales-intelligence.js')||!(html.includes('bundle-sales-intelligence.css')||html.includes('assets/css/app.css')))throw new Error('Intelligence assets are not linked');
