...
for(const [tab,needle] of [['Costing & Margin','Record labour'],['Scope & Tasks','Add task'],['Materials','Save material plan'],['Procurement','No Purchase Orders'],['Settings','Project commercial settings'],['Orders & Pricing','Sales orders · cost & selling prices'],['Extras & Approvals','Project quotes & extras'],['Correspondence','Save correspondence'],['Overview','What needs attention']]){await click('data-project-tab',tab);assert(screen.innerHTML.includes(needle),tab+' opens correctly')}
