...
must(index.includes("./assets/js/01-legacy-01.js?v=1.7.5"),"critical Sales Order finder runtime is release-versioned");
must(index.includes("./sales-workspace.js?v=1.7.5"),"Sales Order workspace runtime is release-versioned");
must(index.includes("./assets/css/app.css?v=1.7.5"),"compiled UI stylesheet is release-versioned");
must(sw.includes("pool-shed-v1.7.5-ui-ownership"),"service worker cache namespace advanced");
must(sw.includes("./assets/js/01-legacy-01.js?v=1.7.5"),"service worker precaches versioned finder runtime");
