...
const studio=fs.readFileSync("public/bundle-studio-v229.js","utf8");
...
const checks=[
 ...
 [studio.includes("data-bs-picker-modal"),"bulk catalogue modal exists"],
 [studio.includes("data-bs-picker-select"),"multi-select controls exist"],
 [studio.includes("Add selected products"),"bulk add action exists"],
 [html.includes("v2.2.9-functional-bundle-actions"),"build marker updated"]
];
for(const [ok,msg] of checks){if(!ok)throw new Error("Failed: "+msg);console.log("PASS",msg)}
console.log("Bundle Studio v2.2.7 checks passed");
