...
assert(html.includes('quote-customer-portal.css?v=1.44.1'));
assert(html.includes('quote-customer-portal.js?v=1.44.1'));
assert(!js.includes('supplier cost')&&!js.includes('unitCost'),'Customer portal must not introduce internal commercial fields');
console.log('PASS v1.44.1 V9.2 private-client proposal design with preserved secure customer interactions');
