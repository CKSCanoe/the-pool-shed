...
for(const token of [
  'Private client proposal','Private for ','pc-scroll-cue','Designed carefully. Delivered properly.',
  'pc-confidence','pc-project-bar','Review ','pc-accept-stepbar','Signature preview',
...
assert(html.includes('quote-customer-portal.css?v=1.38.0'));
assert(html.includes('quote-customer-portal.js?v=1.38.0'));
assert(!js.includes('supplier cost')&&!js.includes('unitCost'),'Customer portal must not introduce internal commercial fields');
console.log('PASS v1.38.0 V9.2 private-client proposal design with preserved secure customer interactions');
