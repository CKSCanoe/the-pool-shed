Today 12:33 PM
how do i delete all the files in res github 

If you want to delete everything in the repository and start again, you have a few options.

Option 1 – Delete everything from the GitHub website (easiest)
Open your repository.
Click into each folder (dist, public, scripts, worker).
Open each file.
Click the 🗑 Delete this file icon (top right).
Commit the changes.

Note: GitHub's web interface cannot delete folders directly. Empty folders disappear automatically once all files inside them are deleted.

Option 2 – Delete everything locally (recommended)
...
git push
Option 3 – Delete and recreate the repository (fastest)

Since it looks like a brand-new repository with only one commit:
...
Upload your new project.

This is usually the cleanest approach if you don't need the history.

If your goal is to replace the project completely

You don't actually need to delete anything first.

Simply drag your new project into the repository (or push it with Git). Files with the same names will be replaced, and you can delete any old files that no longer exist.

If you're trying to upload a completely new version of The Pool Shed, I can also show you the quickest way to wipe the repository and upload the new project in under 2 minutes.
