...
(function () {
  ...
  salesOrderDetail = function(order) {
    return originalDetail(order).replace('sales-order-compact', 'sales-order-compact sales-workspace');
  };
  const originalCustomer = customerProfileCard;
  customerProfileCard = function(order, c) {
    return originalCustomer.apply(this, arguments).replace('<div class="customer-toolbar">',
