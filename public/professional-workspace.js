...
(function(){
 ...
 sidebarSubGroups=function(id){const list=baseGroups(id).slice();if(id==='jobs'&&!list.includes('Tool Register'))list.push('Tool Register');if(id==='dashboard'&&isAdminUser())list.push('Operations Review');return list;};
